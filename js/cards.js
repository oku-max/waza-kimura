...
export function cardHTML(v) {
  ...
  const thumb = isYT ? (v.thumb || `https://img.youtube.com/vi/${ytId}/mqdefault.jpg`)
              : isGD ? (v.thumb && !v.thumb.includes('drive.google.com/thumbnail') ? v.thumb : '')
              : isX  ? (v.thumb || '')
