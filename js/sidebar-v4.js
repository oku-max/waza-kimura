...
#v4-popup{position:fixed;top:50%;left:50%;transform:translate(-50%,-50%);width:min(1100px,calc(100vw - 16px));height:min(640px,calc(var(--zvh-100,100vh) - 16px));max-height:calc(var(--zvh-100,100vh) - 16px);background:var(--surface);color:var(--text);box-shadow:0 8px 32px rgba(0,0,0,.5);border:1px solid var(--border);border-radius:12px;overflow:hidden;display:none;flex-direction:column;z-index:100001}
@supports not (height:100svh){#v4-popup{height:min(560px,calc(var(--zvh-100,100vh) - 16px));max-height:calc(var(--zvh-100,100vh) - 16px)}}
...
@media (max-width:560px){#v4-popup{width:calc(100vw - 16px);height:calc(var(--zvh-100,100vh) - 16px)}}
