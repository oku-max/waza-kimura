// ═══ WAZA KIMURA — 動画パネル（VPanel） v51.66 ═══
...
#vp-bs-sheet{position:fixed;left:0;right:0;bottom:0;z-index:401;background:var(--surface);border-radius:16px 16px 0 0;box-shadow:0 -4px 24px rgba(0,0,0,.2);max-height:calc(60vh * var(--asz-inv,1));transform:translateY(100%);transition:transform .25s ease;display:flex;flex-direction:column}
