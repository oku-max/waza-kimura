// ═══ WAZA KIMURA — 動画パネル（VPanel） v52.81 ═══
...
function _shuffleSVG() {
  return `<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><polyline points="14 1 17 4 14 7"/><path d="M4 20c5 0 9-16 13-16"/><polyline points="14 17 17 20 14 23"/><path d="M4 4c5 0 9 16 13 16"/></svg>`;
}
